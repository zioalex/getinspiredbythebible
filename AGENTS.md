...
Merging with failing CI can introduce bugs and break the build. If a CI failure is a false positive or unrelated to
your changes, document this clearly and consider if the PR should proceed anyway (with justification).
