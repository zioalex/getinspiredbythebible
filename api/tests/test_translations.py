...
def test_russian_api_canonical_book_names():
    ...
    synodal_canonical_names = [
        ...
        "Иисуса Навина", "Судей", "Руфь",
        "1-я Царств", "2-я Царств", "3-я Царств", "4-я Царств",
        "1-я Паралипоменон", "2-я Паралипоменон",
        "Ездры", "Неемии", "Есфирь", "Иов", "Псалтирь", "Притчи",
        ...
        "Иакову", "1-е Петру", "2-е Петру",
        "1-е Иоанну", "2-е Иоанну", "3-е Иоанну", "Иуде",
        "Римлянам",
        "1-е Коринфянам", "2-е Коринфянам",
        "Галатам", "Ефесянам", "Филиппийцам", "Колоссянам",
        "1-е Фессалоникийцам", "2-е Фессалоникийцам",
        "1-е Тимофею", "2-е Тимофею", "Титу", "Филимону",
        "Евреям", "Откровение",
    ]
