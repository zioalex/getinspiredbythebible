...
*Generated 2026-08-01 by `tools/repo-metrics/` — history 2026-01-18 → 2026-07-31. Interactive dashboard: [index.html](./index.html).*

## Headline

| Metric | Value |
|---|---|
| Units of work landed on main (PRs + direct commits, release bumps excluded) | **744** |
| Calendar span | 195 days (156 active — 80%) |
| Code lines added / deleted | +165,487 / −22,771 (net +142,716) |
| Releases shipped | 91 |
| fix : feat ratio | **1.73** |
| Same-day hotfix releases (<24h after previous) | 29 |
| Regression fixes (fix ≤7 days after related feat) | 183 (70 same-scope) |
| Fix chains (≥2 fixes, same scope, ≤7-day gaps) | 31 |
| Reverts | 2 |
...
| Post-launch | 348 | 77/91 | 4.52 | 86 | 116 | 1.35 | +69,902 / −7,393 |
...
Overall churn ratio (deleted/added code lines): **0.138** — 14% of written code was later removed or rewritten.
...
| File | Changes |
|---|---|
| `.github/workflows/azure-deploy.yml` | 81 |
| `api/config.py` | 53 |
...
Production-incident proxies: 29 same-day hotfix releases out of 91 total; 2 reverts.
...
| 2026-07-03 | Adversarial risk audit: playbook, /risk-audit command, baseline report | 1.72 | 1.18 | — |
| 2026-07-03 | Self-measuring productivity metrics tooling added | 1.72 | 1.18 | — |

## Models & harness

Of 1,200 commits in the full graph, 147 are automation bots; of the rest, **677 (64%) carry an AI co-author trailer**. Per-commit Co-Authored-By trailers across all commits (branch commits included; release/dependabot bot commits counted separately). Absence of a trailer does not prove no AI was involved — early history under-reports.

| Model / author | Commits | feat | fix | About |
|---|---|---|---|---|
| human/unattributed | 376 | 52 | 111 |  |
| Claude (unversioned) | 324 | 88 | 135 | Commits co-authored as plain 'Claude' via Claude Code before version names were recorded in trailers. |
...
|---|---|---|---|---|
| android | 231 | 27,804 | 51 | 10,030 |
| api | 178 | 52,075 | 80 | 30,297 |
| ci | 25 | 5,879 | 1 | 608 |
| data | 7 | 0 | 0 | 0 |
| docs | 212 | 54,606 | 0 | 0 |
| frontend | 164 | 37,663 | 49 | 10,278 |
| infra | 26 | 7,656 | 0 | 0 |
| root | 27 | 4,000 | 3 | 1,063 |
| scripts | 44 | 7,820 | 3 | 773 |
| tools | 8 | 2,779 | 1 | 96 |
...
| 2026-08-01 | 744 | 1.73 | 142,716 | 91 | 183 |
