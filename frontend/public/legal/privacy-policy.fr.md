...
- **Messages de chat** : le texte que vous saisissez est envoyé à notre API pour générer des réponses basées sur les Écritures. Nous ne conservons pas vos messages sur nos serveurs au-delà du temps nécessaire pour générer une réponse.
