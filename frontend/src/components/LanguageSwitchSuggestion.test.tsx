...
describe('LanguageSwitchSuggestion', () => {
  it('shows the human-readable language name for a known locale', () => {
    renderWithIntl(
      <LanguageSwitchSuggestion suggestedLocale="it" onSwitch={vi.fn()} onDismiss={vi.fn()} />
    );
  ...
  it('calls onSwitch when Switch button is clicked', () => {
    ...
    renderWithIntl(
      <LanguageSwitchSuggestion suggestedLocale="it" onSwitch={onSwitch} onDismiss={vi.fn()} />
    );
  ...
  it('calls onDismiss when dismiss button is clicked', () => {
    ...
    renderWithIntl(
      <LanguageSwitchSuggestion suggestedLocale="it" onSwitch={vi.fn()} onDismiss={onDismiss} />
    );
  ...
  it('falls back to the raw locale code for unknown locales', () => {
    renderWithIntl(
      <LanguageSwitchSuggestion suggestedLocale="xx" onSwitch={vi.fn()} onDismiss={vi.fn()} />
    );
  ...
  it('has responsive flex layout', () => {
    const { container } = renderWithIntl(
      <LanguageSwitchSuggestion suggestedLocale="de" onSwitch={vi.fn()} onDismiss={vi.fn()} />
    );
