...
describe('ChurchFinderInlinePrompt', () => {
  it('renders inline text', () => {
    renderWithIntl(<ChurchFinderInlinePrompt onFindChurch={vi.fn()} onDismiss={vi.fn()} />);
    expect(screen.getByText('Looking for a prayer community or church?')).toBeDefined();
  });
  ...
  it('calls onFindChurch when CTA clicked', () => {
    ...
    renderWithIntl(<ChurchFinderInlinePrompt onFindChurch={onFindChurch} onDismiss={vi.fn()} />);
  ...
  it('calls onDismiss when dismiss button clicked', () => {
    ...
    renderWithIntl(<ChurchFinderInlinePrompt onFindChurch={vi.fn()} onDismiss={onDismiss} />);
