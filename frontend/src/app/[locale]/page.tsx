    ...
    <main className="flex h-dvh">
      ...
      {relevantVerses.length > 0 && (
        <button
          ...
          className="lg:hidden fixed top-20 right-4 z-20 flex items-center gap-2 px-4 py-3 bg-primary-600 text-white rounded-full shadow-lg hover:bg-primary-700 transition-colors"
